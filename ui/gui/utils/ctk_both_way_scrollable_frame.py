...
class CTkBothWayScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
                 master: Any,
                 width: int = 200,
                 height: int = 200,
        ...
        self._x_scrollbar = CTkScrollbar(master=self._parent_frame, orientation="horizontal", command=self._parent_canvas.xview,
                                        fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
        self._parent_canvas.configure(xscrollcommand=self._x_scrollbar.set)
        
        self._y_scrollbar = CTkScrollbar(master=self._parent_frame, orientation="vertical", command=self._parent_canvas.yview,
                                        fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
        self._parent_canvas.configure(yscrollcommand=self._y_scrollbar.set)
    ...
    def _create_grid(self):
        ...
        self._x_scrollbar.grid(row=2, column=0, sticky="nsew", padx=border_spacing)
        self._y_scrollbar.grid(row=1, column=1, sticky="nsew", pady=border_spacing)
    ...
    def cget(self, attribute_name: str):
        if attribute_name == "width":
            ...
            return self._x_scrollbar.cget("fg_color")
        elif attribute_name.startswith("scrollbar_button_color"):
            return self._x_scrollbar.cget("button_color")
        elif attribute_name.startswith("scrollbar_button_hover_color"):
            return self._x_scrollbar.cget("button_hover_color")
